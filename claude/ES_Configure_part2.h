/****************************************************************************
 ...
 When           Who     What/Why
 -------------- ---     --------
 01/21/2026     karthi24    Added ES_NEW_EDGE for Part 2
 01/21/2026     karthi24    started modifications for lab 6
...
// How big should this services Queue be?
// Increased for Part 2 - encoder edges can come fast
...
typedef enum
{
  ...
  ES_NEW_EDGE,              /* signals a new encoder edge detected (Part 2) */
  ES_LOCK,
  ES_UNLOCK
}ES_EventType_t;
