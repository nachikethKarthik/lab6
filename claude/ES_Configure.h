/****************************************************************************
 ...
 When           Who     What/Why
 -------------- ---     --------
 01/21/26       Student  Modified for Lab 6 Part 1
...
#endif
#if NUM_DIST_LISTS > 1
#define DIST_LIST1 PostMotorService
#endif
#if NUM_DIST_LISTS > 2
...
/****************************************************************************/
// Timer assignments - give timers symbolic names
#define MOTOR_TIMER 0

/****************************************************************************/
// Timer response function definitions
